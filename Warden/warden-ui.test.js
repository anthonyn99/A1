...
g.WardenStore = function(){}; g.WardenSession = function(){}; g.WardenSession.localStorageDeviceStore=()=>({});
...
require('./warden-ui.js');
const V = g.Warden; let pass=0, fail=0;
...
(async()=>{
  ...
  ok('empty warden does not crash', V.analyzeHealth([], now).score>=0);
