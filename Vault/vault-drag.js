/* ============================================================================
 * vault-drag.js — reusable horizontal drag-to-reorder
 *
 * One implementation, mounted on every re-orderable strip in Vault: the tab bar
 * (#vault-tabs) and the header actions (#kc-hbar-actions). Ported from Insight's
