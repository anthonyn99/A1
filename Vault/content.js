...
(function () {
  ...
  function ensureBox() {
    ...
    style.textContent = `
      ...
      .v-head{display:flex;align-items:center;gap:6px;padding:8px 11px;border-bottom:1px solid #34343a;color:#e0a63f;font-size:11px;font-weight:800;letter-spacing:.3px}
      ...
      .v-exp.warn{color:#e0a63f}
      .v-exp.bad{color:#d68a7c}
      .v-star{color:#e0a63f;flex-shrink:0;line-height:0;display:inline-flex;margin-right:5px}.v-star svg{width:11px;height:11px;display:block}
  ...
  function keyIconSVG() {
    return '<svg class="v-dot" viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#e0a63f" stroke-width="2"><path d="M21 2l-2 2m-7.6 7.6a5.5 5.5 0 1 1-7.8 7.8 5.5 5.5 0 0 1 7.8-7.8zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3"/></svg>';
  }
  function cardIconSVG() {
    return '<svg class="v-dot" viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#e0a63f" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/></svg>';
  }
