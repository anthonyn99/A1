...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.vault-tab:hover{color:var(--tx);border-color:var(--txd)}.vault-tab.active{background:transparent;color:var(--acs,#d4a659);border-color:var(--ac)}',
      ...
      '.vault-icon:hover{color:var(--acs,#d4a659);border-color:var(--ac)}',
      '.vault-icon.vpay-on,.vault-icon.vault-on{color:var(--acs,#d4a659);border-color:var(--acl,rgba(212,166,89,.36))}',
      ...
      '.vault-link-btn{background:none;border:none;color:var(--txd);font-size:12px;font-weight:500;cursor:pointer;padding:4px 8px;display:inline-flex;align-items:center;gap:7px;transition:color .15s}.vault-link-btn:hover{color:var(--acs,#d4a659)}',
      ...
      '.vault-btn:hover{border-color:var(--txd)}.vault-btn.primary{background:transparent;color:var(--acs,#d4a659);border-color:var(--acl,rgba(212,166,89,.36))}.vault-btn.primary:hover{border-color:var(--ac)}',
      ...
      '.vault-gen-tab{flex:1;background:var(--s2);border:1px solid var(--bd);color:var(--txd);border-radius:var(--radius-sm);padding:8px;font-size:12px;font-weight:500;cursor:pointer}.vault-gen-tab.active{background:transparent;color:var(--acs,#d4a659);border-color:var(--ac)}',
