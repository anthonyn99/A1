// Connection-card drag-to-reorder for the Vault Launcher popup.
//
// Deliberately the same mechanic as the Keychain card DnD in the Vault app
// (vault.html, kc card pointer handlers): a dashed placeholder takes the card's
...
//
// NOTE: this is the CARD drag module, separate from vault-drag.js (which
...
if (typeof globalThis !== "undefined") globalThis.VaultCardDrag = VaultCardDrag;
