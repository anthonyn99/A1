...
const VERSION = '2026-06-22-fast-chunks';
...
const CHUNK_MAX_OUT_TOKENS = 2048;    // smaller chunks = faster generation, fits wall-time
const CHUNK_WALK_BUDGET_MS = 22 * 1000; // hard cap per chunk walk — degrade before CF kills it
