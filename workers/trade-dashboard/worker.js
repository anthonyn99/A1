...
function cors(req){
  ...
  return {'Access-Control-Allow-Origin':allow,'Access-Control-Allow-Methods':'GET,POST,DELETE,OPTIONS','Access-Control-Allow-Headers':'Content-Type, Cache-Control, Pragma, X-Firebase-AppCheck','Vary':'Origin'};
}
...
async function handle(request, env, ctx){
  ...
  // App Check gate. The watchlist is a personal position list and the calendar
  // is derived from it. /analysis-config is deliberately NOT gated: the Vault
