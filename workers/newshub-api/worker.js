...
const BATCH_SIZE = 3;        // 3 events/batch — small enough the model reliably
                             // returns ALL of them. At 6+ it omitted ~half, leaving
                             // real news stuck as RAW. More batches, but they run as
                             // one concurrent wave so wall-time barely changes.
const MAX_EVENTS = 30;       // 10 batches of 3.
