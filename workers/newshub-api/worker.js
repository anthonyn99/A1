...
const AI_CALL_TIMEOUT = 40000; // ms — 8-event call is well under this; generous
                             // headroom so a healthy-but-slow call isn't killed
  ...
  async fetch(req, env, ctx){
    ...
    if (url.pathname === '/test-ai'){
      try {
        ...
        const model = url.searchParams.get('model') || (provider === 'nim' ? 'meta/llama-3.3-70b-instruct' : 'gemini-2.5-flash-lite');
